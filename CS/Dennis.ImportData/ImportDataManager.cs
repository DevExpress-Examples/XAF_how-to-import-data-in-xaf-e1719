...
namespace Dennis.ImportData {
    /// <summary>
    /// Dennis: This delegate should be used to create persistent objects during data import. Use the Session and args parameters to create new persistent objects.
